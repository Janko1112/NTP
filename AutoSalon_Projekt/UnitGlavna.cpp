...
void __fastcall TFormGlavna::BtnPokreniDretveClick(TObject *Sender)
{
    ...
    TTask::Run([this]() {
        ...
        int brojKupaca = 0;
        double kompleksnaSimulacijaTrzista = 0.0;
